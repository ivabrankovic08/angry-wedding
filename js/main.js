...
$(document).ready(function() {
  ...
  const collectDate = (dateInput) => {
    ...
    selectedDate.setMonth(date[1] - 1);
  ...
  btnNext1.addEventListener('click', () => {
    reveal("#div2");
    hide("#div1");
    novaKonsultacija.korisnik = name.value;
    novaKonsultacija.email = email.value;
    console.log(novaKonsultacija);
  })
  ...
  btnNext3.addEventListener('click', () => {
    if(isValidDate($('#date'))) {
      reveal('#div4');
      novaKonsultacija.datum = `${day}.${month}.${year}.`;
      hide(".error3");
    } else {
      reveal(".error3");
    }
  ...
  btnSubmit.addEventListener("click", () => {
    ...
    addCellToTable(newRow, novaKonsultacija.korisnik)
    addCellToTable(newRow, novaKonsultacija.datum)
    addCellToTable(newRow, novaKonsultacija.tip);
